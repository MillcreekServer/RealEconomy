...
import io.github.wysohn.realeconomy.mediator.*;
import org.bukkit.*;
...
public class RealEconomy extends AbstractBukkitPlugin {
    ...
    protected void init(PluginMainBuilder pluginMainBuilder) {
        ...
        pluginMainBuilder.addModule(new ListingInfoModule());
                        ...
                        getMain().getManager(ManagerLanguage.class).ifPresent(lang -> {
                            getMain().task().async(() -> {
                                ...
                                getMain().task().sync(() -> {
                                    ...
                                    lang.sendMessage(sender, RealEconomyLangs.Command_Price_Format_Header_Top);
                                    ...
                                    lang.sendMessage(sender, RealEconomyLangs.Command_Price_Format_Header_Trends, (sen, man) ->
                                            man.addInteger(7)); //TODO later may change
